...
const Skills = () => {
    return (
        <section className='mt-28 lg:px-[100px]'>
            <div className="flex flex-col lg:flex-row w-full lg:justify-between items-center">
                <div className='left-wr lg:w-1/2 text-2xl lg:text-3xl text-white font-semibold relative text-center lg:text-left mb-12 lg:mb-0'>
